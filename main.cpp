...
void render() {
	...
	Vertex2 poly2[4] = {Vertex2(321,335), Vertex2(288,286), Vertex2(339,251), Vertex2(374,302)};
	...
	Vertex2 poly1[10] = {Vertex2(165,380), Vertex2(185,360), Vertex2(180,330), Vertex2(207,345), Vertex2(233,330), Vertex2(230, 360), Vertex2(250,380), Vertex2(220,385), Vertex2(205,410), Vertex2(193,383)};
	
	drawPolygon(poly1, sizeof(poly1)/sizeof(poly1[0]));
	setCurrentColor(255,255,0);
	fillPolygon(200, 350);

	drawPolygon(poly2, sizeof(poly2)/sizeof(poly2[0]));
